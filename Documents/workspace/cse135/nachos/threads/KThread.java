...
public class KThread {
	...
	public static void finish() {
		...
		if(threadThatJoined != null) {
			threadThatJoined.ready();
		}
	...
	public void join() {
		...
		threadThatJoined = currentThread;
		threadThatMustFinish = this;
		currentThread.sleep();
	...
	private KThread threadThatJoined = null;
	
	private KThread threadThatMustFinish = null;
}
